...
#
# A diferencia de git_token (un PAT de un servicio externo, provisto por
# humano), esta es una credencial de primer partido: no hay nada que un
# humano deba "saber" de antemano, asi que se genera con random_password,
# el mismo patron ya usado para la contraseña de RDS (ver rds.tf) - nadie
# elige ni commitea un valor, Terraform es la unica fuente de verdad.
# ============================================================
